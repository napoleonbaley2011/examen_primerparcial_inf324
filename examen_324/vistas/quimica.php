...
<body>
    ...
    <section id="inicio" class="inicio">
        <div class="contenido-palabra">
			<h2>QUIMICA</h2>
			<div class="derecha"><a class="boton-ad boton-ad-editar" href="adicionar.php?mat=<?php $_SESSION['session']['materia'] = "QMC"?>">+ CREAR ESTUDIANTE</a></div>
                            ...
                            while($data = mysqli_fetch_array($res1)){
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="boton-ad boton-ad-editar" href="editar.php?ci=<?php echo $data['ci']; $_SESSION['session']['materia'] = "QMC"?>">Editar</a>
                                            <a class="boton-ad boton-ad-editar" href="eliminar.php?ci=<?php echo $data['ci']; $_SESSION['session']['materia'] = "QMC"?>">Eliminar</a>
                                        </td>
                                    </tr>    
