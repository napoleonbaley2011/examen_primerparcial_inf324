        ...
        <header>
            ...
            <nav id="nav">
                <ul>
                    ...
                    <li><a href="#sobremi" onclick="seleccionar()">MATEMATICAS</a></li>
                    <li><a href="#skills" onclick="seleccionar()">INFORMATICA</a></li>
                    <li><a href="#curriculum" onclick="seleccionar()">QUIMICA</a></li>
